  ...
  return (
    <Card className="mt-6 w-[340px]">
      ...
      <CardFooter className="pt-0 flex justify-center">
        <Link to={link}>
          <div>
            <a class="relative inline-flex items-center justify-center px-8 py-3 overflow-hidden text-lg font-medium tracking-tighter text-white bg-[#43a047]  rounded-lg group">
