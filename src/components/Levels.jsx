...
const Levels = () => {
  ...
  const levels = [
    { name: "A1", descKey: "levelA1", color: "from-orange-400 to-orange-600", icon: "🌱" },
    { name: "A2", descKey: "levelA2", color: "from-orange-500 to-purple-500", icon: "📚" },
    { name: "B1", descKey: "levelB1", color: "from-purple-500 to-purple-600", icon: "💬" },
    { name: "B2", descKey: "levelB2", color: "from-purple-600 to-orange-500", icon: "🎯" },
    { name: "C1", descKey: "levelC1", color: "from-orange-500 to-purple-600", icon: "🎓" },
    { name: "C2", descKey: "levelC2", color: "from-purple-600 to-orange-500", icon: "👑" }
  ];

  return (
    <div className="mt-32">
      <div className="text-center mb-12">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">{t("levelsTitle")}</h2>
        ...
        {levels.map((level, index) => (
          <div key={level.name} className="group relative bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:border-orange-500/50 transition-all hover:-translate-y-1">
            <div className="flex items-center justify-between mb-2">
              <span className={`text-xl sm:text-3xl font-bold bg-gradient-to-r ${level.color} bg-clip-text text-transparent`}>
                {level.name}
              </span>
            ...
            <p className="text-white/90 text-base mb-3">{t(level.descKey)}</p>
