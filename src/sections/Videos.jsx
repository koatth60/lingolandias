...
const Videos = () => {
  return (
    <section className=" w-full flex justify-center md:px-[30x]">
      <div className=" h-auto font-satoshi lg:max-w-[1245px] relative flex justify-center items-center max-lg:flex-col-reverse lg:p-16 md:px-6 md:py-8 gap-8 bg-white rounded-3xl shadow-xl xl:my-[50px] max-lg:mb-[260px] max-md:mb-[360px] md:mx-[30px] ">
        <div className="flex flex-col items-center">
        <h2 className=" font-bold text-[#6a1b9a] xl:text-5xl lg:text-4xl md:text-3xl text-center xl:my-8 xl:pb-3 pb-6">
            Studenci zadowoleni z{" "}
            <span className="xl:text-5xl lg:text-4xl max-lg:text-2xl font-bold bg-[#43a047] text-white xl:w-[220px] md:w-[150px] max-md:w-[130px] max-md:text-center rounded-2xl px-2 pb-1 ">
              Lingolandias.
            </span>
            
          </h2>
          <p className="text-[#9c27b0] font-medium text-xl text-center xl:mb-[50px] lg:mb-[35px] md:mb-[20px]">
          ...
          <div>
            <div className="w-full flex justify-between mb-14">
              ...
              <div className="w-2/4  py-2 px-4">
                <h2 className="text-center text-[#9c27b0] lg:text-2xl md:text-xl font-bold">
