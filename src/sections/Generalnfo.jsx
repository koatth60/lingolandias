    ...
    <section className="w-full flex justify-center md:px-0 px-3">
      <div className="h-auto font-satoshi lg:max-w-[1245px] relative xl:my-[50px] mb-[70px] md:mx-[30px]">
        <div className="flex justify-center items-center max-lg:flex-col-reverse lg:p-16 md:px-6 md:py-8 gap-8 bg-white rounded-3xl shadow-xl">
          <div className=" w-full md:px-0 px-3 md:py-0 py-5">
            <h2 className=" font-bold text-[#6a1b9a] xl:text-5xl lg:text-4xl md:text-3xl text-3xl text-center xl:my-8 xl:pb-3 pb-6">
              {t("genInfo")}{" "}
